<%@ Page Title="Booking" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Book.aspx.cs" Inherits="Book" %>
...
<p>
    ...
    <div ID="Panel1" runat="server" Visible="False" class="row">
        <div class="col-md-6">
